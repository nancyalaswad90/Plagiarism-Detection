...
if __name__ == '__main__':
    ...
    ## TODO: Define the optimizer with the loss function to train the model
    optimizer = optim.Adam(model.parameters(), lr=args.lr)
    criterion = nn.BCELoss()

    # Trains model , the given line of code, which calls for above training function
    train(model, train_loader, args.epochs, criterion, optimizer, device)

    ## TODO: complete model_info with adding (3) arguments names, (( with note first))
